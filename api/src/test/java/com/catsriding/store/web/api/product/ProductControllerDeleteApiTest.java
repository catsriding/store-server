...
@Tag("restdocs")
class ProductControllerDeleteApiTest extends IntegrationTestSupport {
    ...
    void docsProductDeleteApi() throws Exception {

        //  Given
        User user = createTestUser();
        Product existing = createExistingProduct(user);

        //  When
        ResultActions actions = mockMvc.perform(delete("/products/{productId}", existing.id())
