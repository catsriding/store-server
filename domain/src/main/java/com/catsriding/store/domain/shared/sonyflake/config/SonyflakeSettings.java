package com.catsriding.store.domain.shared.sonyflake.config;

import com.catsriding.store.domain.shared.sonyflake.exception.InvalidMachineIdException;
import com.catsriding.store.domain.shared.sonyflake.exception.NoPrivateAddressException;
import com.catsriding.store.domain.shared.sonyflake.spec.SonyflakeMachineIdSpec;
import com.catsriding.store.domain.shared.sonyflake.spec.SonyflakeStartTimeSpec;
