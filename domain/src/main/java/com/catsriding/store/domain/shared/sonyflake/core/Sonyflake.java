...
import com.catsriding.store.domain.shared.sonyflake.config.SonyflakeSettings;
import com.catsriding.store.domain.shared.sonyflake.exception.OverTimeLimitException;
import com.catsriding.store.domain.shared.sonyflake.exception.SonyflakeException;
...
public final class Sonyflake {
    ...
    private static class SingletonHolder {
        ...
        private static final SonyflakeSettings settings = SonyflakeSettings.of(Instant.parse("2025-01-01T00:00:00Z"));
